                    ...
                    <div class="modal-body">
                        <form>
                            <fieldset>
                                ...
                                Area: <input type="text" name="area" placeholder="Area"/><br/>
                                Cost: <input type="text" name="cost" placeholder="Cost"/><br/>
                                Max people: <input type="text" name="max_people" placeholder="Max people"/><br/>
                                Rent type: <input type="text" name="rent_type" placeholder="Rent type"/><br/>
                                Standard room: <input type="text" name="standard_room"
                                                      placeholder="Standard room"/><br/>
                                Des other convenience: <input type="text" name="description_other_convenience"
                                                              placeholder="Des other convenience"/><br/>
                                Pool area: <input type="text" name="pool_area" placeholder="Pool area"/><br/>
                                Number floors: <input type="text" name="num_of_floors"
                                                      placeholder="Numbers floors"/><br/>
                                Facility free: <input type="text" name="facility_free"
